...
var templates = [
    ...
    },
    {
        ...
        "html":'<h1 class="ue_t" label="Title center" name="tc" style="border-bottom-color:#cccccc;border-bottom-width:2px;border-bottom-style:solid;padding:0px 4px 0px 0px;text-align:center;margin:0px 0px 20px;"><span style="font-size: 24px">标题</span><br></h1><table width="100%"><tr><td width="20%" align="right">申请人:</td><td width="30%">&nbsp;</td><td width="20%" align="right">申请时间:</td><td width="30%">&nbsp;</td></tr></table><p class="ue_t"><br /></p>'
    },
    {
        "pre":"pre2.gif",
        'title':lang.blog,
